...
Samples of Category II data: On overage, they scored {TG} and {TH} before Full-time and Half-Time in their last 6 head to head matches. More Category II data is availble from Col 39 to 54 \n".format(dtype=Dtype,wday=datin[3],day=int(datin[4]),month=int(datin[5]),hh=int(datin[7]),mm=int(datin[8]),\
        t1=datin[13],t2=datin[14],tbetter=int(datin[9]),vhome=int(datin[0]),vdraw=int(datin[1]),vaway=int(datin[2]),phome=int(datin[10]),pdraw=int(datin[11]),paway=int(datin[12]), \
        R1=int(datin[15]),R2=int(datin[16]),tteams=int(datin[9]),GP1=int(datin[18]),GP2=int(datin[19]),P1=int(datin[20]),P2=int(datin[21]),Pmax=int(datin[22]),Pmin=int(datin[23]),\
        Ph=int(100*datin[51]**(-1)),Pd=int(100*datin[52]**(-1)),Pa=int(100*datin[53]**(-1)),TG=datin[47],TH=datin[48]))
...
No Category II data is availble \n".format(dtype=Dtype,wday=datin[3],day=int(datin[4]),month=int(datin[5]),hh=int(datin[7]),mm=int(datin[8]),\
        t1=datin[13],t2=datin[14],tbetter=int(datin[9]),vhome=int(datin[0]),vdraw=int(datin[1]),vaway=int(datin[2]),phome=int(datin[10]),pdraw=int(datin[11]),paway=int(datin[12]), \
        R1=int(datin[15]),R2=int(datin[16]),tteams=int(datin[9]),GP1=int(datin[18]),GP2=int(datin[19]),P1=int(datin[20]),P2=int(datin[21]),Pmax=int(datin[22]),Pmin=int(datin[23]),\
        Ph=int(100*datin[51]**(-1)),Pd=int(100*datin[52]**(-1)),Pa=int(100*datin[53]**(-1))))
    elif str(datin[20]) == "nan" and str(datin[48]) != "nan":
        Dtype='Mode 3'
        print("- It is {dtype}, to kick off on {wday}, Date: {day}/{month}, Time: {hh}:{mm}, CET, The match is between {t1} and {t2}.\n\
{vhome} experts voted for home win, {vdraw} voted for draw and {vaway} ones for Away win. \n\
